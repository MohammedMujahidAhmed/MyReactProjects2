        ...
        <div className='overflow-scroll no-scrollbar w-9/12 max-w-[1100px] mt-[60px] mb-[60px] '>
            <div className='flex items-center justify-between'>
                <div className='flex  space-x-2 items-center'>
                    ...
                    <p> <span className='text-xl font-bold'>Blogs Tagged</span> <span className='text-xl underline text-blue-700 font-bold'>#{location.pathname.split('/').at(-1).replaceAll('-',' ')}</span> </p> 
                </div>
